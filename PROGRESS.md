...
[+] plan1/1.1/1.1.2 — 2026-08-04 — Jira write exception boundary narrowed: transport failures remain uncertain and non-terminal, while programming defects fail safely with a durable pending action; 150 tests passed, 2 skipped, and Ruff clean.
[x] plan1/1.2/1.2.3 — 2026-08-04 — Read-only production DAI client hardened with strict production/JARVIS DAI separation, lifetime-aware OAuth2 token caching, runid-first log retrieval, deterministic screenshot walk-back, configured URL validation, TLS verification, and atomic PNG writes; commit 950d598. User-run live smoke passed for runid 30832: 402 logs, image_id 465c0ecf-7f18-5a0a-77a1-092d06e18785, 111914-byte PNG; 190 tests passed, 2 skipped, and Ruff clean.
[+] plan1/post-1.2.3 — 2026-08-04 — Jira write truthfulness follow-up landed: successful Jira comment responses no longer require a JSON body, while formatter/footer programming defects fail the run and preserve an unattempted pending Jira action; implementation commit da17994; 193 tests passed, 2 skipped, and Ruff clean.
